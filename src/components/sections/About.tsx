      ...
      <>
        <section
            ...
            className={`py-20 bg-white transition-all duration-700 ${
                scrolling ? 'bg-opacity-0' : 'bg-opacity-100'
            }`}
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="transition-all duration-700 transform translate-y-0 opacity-100">
                <h2 className="text-3xl font-bold text-[#0d3445] mb-6">
                  About MemoRaid
                </h2>
                ...
                {stats.map((item, index) => (
                    ...
                    >
                      <div className="flex flex-col items-center bg-[#0d3445]/5 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-500">
                        {item.icon && (
                            <item.icon className="w-8 h-8 text-[#0d3445] mb-3 animate-bounce" />
                        )}
                        <div className="text-2xl font-bold text-[#0d3445] mb-2 text-center">
                          {item.number}
                        </div>
        ...
        <section className="py-20 bg-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-[#0d3445] mb-12 text-center">
              Our Achievements
            </h2>

            <div className="flex justify-center">
              <div className="group relative w-full max-w-md transform transition-all duration-700 hover:scale-105">
                {/* Main Achievement Card with Border */}
                <div className="bg-white p-8 rounded-2xl shadow-xl border-4 border-[#0d3445] transition-all duration-500 hover:shadow-2xl">
                  {/* Image Container */}
